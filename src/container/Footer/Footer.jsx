...
export default function () {
  return (
    ...
    "
              ...
              <p>"Kita tidak dapat memaksakan semua orang untuk menyukai hasil karya kita. Yang dapat kita lakukan adalah menyukai karya foto yang telah kita buat". – Galih Sedayu</p>
            </div>
            <div className>
              <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">Produk Kami</h6>
              <p className="mb-4">
                <a href="#!" className="text-gray-600">
                  Foto Wisuda
                </a>
            ...
            <div className>
              ...
              <p className="flex items-center justify-center md:justify-start mb-4">
                ...
                Citrosono, Grabag, Magelang, Jawa Tegah
              </p>
              <p className="flex items-center justify-center md:justify-start mb-4">
